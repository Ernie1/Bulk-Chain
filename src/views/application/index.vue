  ...
  data() {
    return {
      ...
      rules: {
        ...
        goodsProduceDate: [{ required: true, message: "请输入生产日期", trigger: "blur" }],
        goodsValidityPeriod: [{ required: true, message: "请输入有效期", trigger: "blur" }],
        warehouseID: [{ required: true, message: "请输入仓库ID", trigger: "blur" }],
        inboundPlanTime: [{ required: true, message: "请输入拟入库时间", trigger: "blur" }]
      }
    };
  },
  created() {
